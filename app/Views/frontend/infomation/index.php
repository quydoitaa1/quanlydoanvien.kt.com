    <div class="breadcrumb-panel mb30">
    ...
    <div class="w-contact-form mb20 contact-info">
      <div class="uk-container uk-container-center uk-flex">
        <div class="w-contact-right-side contact-info">
          <div class="w-main-title"> <?php echo $title ?> </div>
          <form class="form uk-form" method="post" action="">
            <div class="uk-grid uk-grid-medium">
                ...
                <div class="uk-width-small-1-1 uk-width-medium-1-3 uk-width-large-3-4">
                    <div class="uk-grid uk-grid-medium">
                        <div class="uk-width-1-4 mb5">
                            <div class="form-row">
                                <label class="control-label text-left">
                        ...
                        <div class="uk-width-1-4 mb5">
                            <div class="form-row">
                                ...
                                <?php echo form_dropdown('user_catalogue_id', $userCatalogue, set_value('user_catalogue_id', (isset($user['user_catalogue_id'])) ? $user['user_catalogue_id'] : ''), 'class="form-control m-b " disabled');?>
                            </div>
                        </div>
                        <div class="uk-width-1-4 mb5">
                            <div class="form-row">
                            ...
                            echo form_dropdown('gender', GENDER, set_value('gender', (isset($user['gender'])) ? $user['gender'] : 0),'class=" form-control mr20 input-sm perpage filter" style="width:100%"');
                            ?>
                            </div>
                        </div>
                        <div class="uk-width-1-4 mb5">
                ...
                <div class="uk-width-small-1-1 uk-width-medium-1-1 uk-width-large-1-1">
                    <div class="uk-grid uk-grid-medium">
                        <div class="uk-width-1-4">
                            ...
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Quê quán (Tỉnh/Thành Phố) <b class="text-danger">(*)</b></span>
                                </label>
                                <?php
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Quê quán (Quận/Huyện) <b class="text-danger">(*)</b></span>
                                </label>
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Quê quán (Phường xã) <b class="text-danger">(*)</b></span>
                                </label>
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Quê quán (Địa chỉ cụ thể) <b class="text-danger">(*)</b></span>
                                </label>
                        ...
                        <div class="uk-width-1-4">
                            ...
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Thường trú (Tỉnh/Thành Phố) <b class="text-danger">(*)</b></span>
                                </label>
                                <?php
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Thường trú (Quận/Huyện) <b class="text-danger">(*)</b></span>
                                </label>
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Thường trú (Phường xã) <b class="text-danger">(*)</b></span>
                                </label>
                        ...
                        <div class="uk-width-1-4">
                            <div class="form-row">
                                <label class="control-label text-left">
                                    <span>Thường trú (Địa chỉ cụ thể) <b class="text-danger">(*)</b></span>
                                </label>
                    ...
                    <div class="uk-grid uk-grid-medium">
                        ...
                        <div class="uk-width-1-6 mb5">
                            <div class="form-row">
                                ...
                                <?php echo form_dropdown('association_position', UNION_POSITION, set_value('association_position', (isset($user['association_position'])) ? $user['association_position'] : ''), 'class="form-row" placeholder="" autocomplete="off"');?>
                            </div>
                        </div>
                        <div class="uk-width-1-6 mb5">
                            <div class="form-row">
                        ...
                        <div class="uk-width-1-6 mb5">
                            <div class="form-row">
                                ...
                                <?php echo form_dropdown('union_position',UNION_POSITION , set_value('union_position', (isset($user['union_position'])) ? $user['union_position'] : ''), 'class="form-row" placeholder="" autocomplete="off"');?>
                            </div>
                        </div>		
                    </div>
                </div>
            </div>
            <div class="w-submit-infor mb10 uk-text-center">
                <input type="submit" name="create" class="btn-submit w-submit" value="Gửi đi">
            </div>
        </form>
