                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-row mb15">
                                            ...
                                            <input value="<?php echo set_value('birthday',$user['birthday']) ?>" type="text" name="birthday" value="" class="form-control datetimepicker" placeholder="" autocomplete="off" id="dp1596117018054">
                                        </div>
                                        <div class="form-row mb15">
                                            <label class="control-label text-left">
                                                <span>Giới tính </span>
