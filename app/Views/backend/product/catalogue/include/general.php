      ...
      <div class="row mb15">
         <div class="col-lg-12">
            <div class="form-row">
               ...
               <?php echo form_input('title', validate_input(set_value('title', (isset($productCatalogue['title'])) ? $productCatalogue['title'] : '')), 'class="form-control '.(($method == 'create') ? 'title' : '').'"  placeholder="" id="title" autocomplete="off"'); ?>
            </div>
         </div>
      </div>
      <div class="row mb15">
