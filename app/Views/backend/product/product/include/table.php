       ...
       <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
           ...
           <td>
               <div class="uk-flex uk-flex-middle">
                   ...
                   <div class="main-info">
                       <div class="title"><a class="maintitle" href="<?php echo site_url('backend/product/product/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a></div>
                       <div class="catalogue" style="font-size:10px">
                           <span style="color:#f00000;">Nhóm hiển thị: </span>
                           <a class="" style="color:#333;" href="<?php echo site_url('backend/product/catalogue/update/'.$val['product_catalogue_id']); ?>" title=""><?php echo ($val['cat_title']) ?? '' ?></a>
