<div class="ibox ibox-seo mb20">
   ...
   <div class="ibox-content">
      <div class="row">
         <div class="col-lg-12">
            <?php
               $metaTitle = (request()->getPost('meta_title')) ? request()->getPost('meta_title') : ( (isset($product['meta_title'])) ? $product['meta_title'] : 'Bạn chưa nhập tiêu đề SEO' );
               $googleLink = (request()->getPost('canonical')) ? request()->getPost('canonical') : ( (isset($product['canonical'])) ? BASE_URL.$product['canonical'].'.html' : BASE_URL.'duong-dan-website.html' );
               $metaDescription = (request()->getPost('meta_description')) ? request()->getPost('meta_description') : ( (isset($product['meta_description'])) ? $product['meta_description'] : 'Bạn chưa nhập tiêu đề SEO' );
