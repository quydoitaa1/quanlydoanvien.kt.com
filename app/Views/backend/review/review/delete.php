<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Xóa thành viên: <?php echo $review['fullname'] ?></h2>
		<ol class="breadcrumb">
			<li>
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('email', set_value('email', $review['email']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', $review['id']), 'class="form-control " placeholder="" autocomplete="off"');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('fullname', set_value('fullname', $review['fullname']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_dropdown('review_catalogue_id', $reviewCatalogue, set_value('review_catalogue_id', $review['review_catalogue_id']), 'class="form-control m-b city" disabled');?>
								</div>
							</div>
						</div>
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('birthday', set_value('birthday', $review['birthday']), 'class="form-control datetimepicker" placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('address', set_value('address', $review['address']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('phone', set_value('phone', $review['phone']), 'class="form-control " placeholder="" autocomplete="off" disabled');?>
								</div>
							</div>
						</div>
