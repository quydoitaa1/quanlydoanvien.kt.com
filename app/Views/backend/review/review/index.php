...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý review</strong></li>
      </ol>
   </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                   <?php echo view(route('backend.review.review.include.filter')) ?>
                   <?php echo view(route('backend.review.review.include.table')) ?>
