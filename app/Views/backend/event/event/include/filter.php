        ...
        <div class="toolbox">
           <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="form-row cat-wrap">
                    <?php echo form_dropdown('semester_id', $dropdown, set_value('semester_id', (request()->getGet('semester_id')) ? request()->getGet('semester_id') : ''), 'class="form-control mr10" style="width:260px;"');?>
                </div>
