        ...
        <div class="toolbox">
           <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="form-row cat-wrap">
                    <?php echo form_dropdown('publish', EVENT_USER, set_value('publish', (request()->getGet('publish')) ? request()->getGet('publish') : ''), 'class="form-control m-b select2 mr10" style="width:220px;"');?>
                </div>
