...
<table class="table table-striped table-bordered table-hover dataTables-example">
   ...
   <tbody>
         ...
         <?php if(isset($voucher['list']) && is_array($voucher['list']) && count($voucher['list'])){ ?>
         <?php foreach($voucher['list'] as $key => $val){ ?>
         <?php
      ...
      <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
        ...
        <td>
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="main-info">
                    <div class="title <?php echo ($val['end_at'] < currentTime()) ? 'del' : '' ?>"><a class="maintitle" href="<?php echo site_url('backend/marketing/voucher/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> <?php echo ($val['end_at'] < currentTime()) ? '<span>- Hết Hạn</span>' : '' ?></a></div>
        ...
        <td class="text-center">
            <a type="button" href="<?php echo base_url('backend/marketing/voucher/update/'.$val['id']) ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
            <a type="button" href="<?php echo base_url('backend/marketing/voucher/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
        </td>
      </tr>
      <?php }}else{ ?>
        <tr>
