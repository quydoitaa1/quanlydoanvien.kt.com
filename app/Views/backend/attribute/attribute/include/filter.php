        ...
        <div class="toolbox">
           <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="form-row cat-wrap">
                    <?php echo form_dropdown('attribute_catalogue_id', $dropdown, set_value('attribute_catalogue_id', (request()->getGet('attribute_catalogue_id')) ? request()->getGet('attribute_catalogue_id') : ''), 'class="form-control m-b select2 mr10" style="width:220px;"');?>
                </div>
                ...
                <div class="uk-button">
                    <a href="<?php echo base_url(route('backend.attribute.attribute.create')) ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i>Thêm Mới</a>
                </div>
           </div>
        </div>
    </div>
