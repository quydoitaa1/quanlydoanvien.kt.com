...
<table class="table table-striped table-bordered table-hover dataTables-example">
   ...
   <tbody>
       ...
       <?php if(isset($attribute['list']) && is_array($attribute['list']) && count($attribute['list'])){ ?>
       <?php foreach($attribute['list'] as $key => $val){ ?>
       <?php
       ...
       <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
           ...
           <td>
               <div class="uk-flex uk-flex-middle">
                   <div class="main-info">
                       <div class="title"><a class="maintitle" href="<?php echo site_url('backend/attribute/attribute/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a></div>
                       <div class="catalogue" style="font-size:10px">
                           <span style="color:#f00000;">Nhóm hiển thị: </span>
                           <a class="" style="color:#333;" href="<?php echo site_url('backend/attribute/catalogue/update/'.$val['attribute_catalogue_id']); ?>" title=""><?php echo ($val['cat_title']) ?? '' ?></a>
           ...
           <td class="text-center">
               ...
               <a type="button" href="<?php echo base_url('backend/attribute/attribute/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
           </td>
       </tr>
       <?php }}else{ ?>
           <tr>
