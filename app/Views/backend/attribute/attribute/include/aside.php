   ...
   <div class="ibox-content">
      <div class="row">
         <div class="col-lg-12">
            ...
            <div class="form-row">
               <?php echo form_dropdown('attribute_catalogue_id', $dropdown, set_value('attribute_catalogue_id', (isset($attribute['attribute_catalogue_id'])) ? $attribute['attribute_catalogue_id'] : ''), 'class="form-control m-b select2"');?>
            </div>

            <script>
               var catalogue = '<?php echo (request()->getPost('catalogue')) ? json_encode(request()->getPost('catalogue')) : ((isset($attribute['catalogue']) && $attribute['catalogue'] != null) ? $attribute['catalogue'] : '');  ?>';
            </script>
