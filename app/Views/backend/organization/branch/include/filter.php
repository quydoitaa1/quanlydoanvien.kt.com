        ...
        <div class="toolbox">
           <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="form-row cat-wrap">
                    <?php echo form_dropdown('faculty_id', $dropdown, set_value('faculty_id', (request()->getGet('faculty_id')) ? request()->getGet('faculty_id') : ''), 'class="form-control mr10" style="width:220px;"');?>
                </div>
