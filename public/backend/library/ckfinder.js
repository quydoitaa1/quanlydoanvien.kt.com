            ...
            li = li + '<li class="ui-state-default select_img_'+dem_img+'">';
                li = li + '<div class="thumb">';
                    li = li + '<span class="image img-scaledown">';
                        ...
                        li = li + '<input type="hidden" value="'+fileUrl+'" class="value-img-banner" name="slide[image][]">';
                    li = li + '</span>';
                    li = li + '<div class="delete-image" style="color:red;"><i class="fa fa-trash" aria-hidden="true"></i></div><div class="show-image"><i class="fa fa-search-plus" aria-hidden="true"></i></div>';
                    li = li + '<div class="title"><input style="border:0;" placeholder="Tiêu đề" type="text" class="form-control" name="slide[title][]" /></div>'
                     li = li + '<div class="link"><input style="border:0;" placeholder="Đường dẫn" type="text" class="form-control" name="slide[canonical][]" /></div>'
                    li = li + '<div class="description"><textarea style="height:98px;border:0;" placeholder="Nội dung" type="text" class="form-control" name="slide[description][]"></textarea></div>'
                li = li + '</div>';
            li = li + '</li>';
            dem_img++;
        }
